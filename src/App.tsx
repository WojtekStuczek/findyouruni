  ...
  return (
    <>
      ...
      {showHelpPrompt && currentPage === 'home' && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 z-[2000] w-[90vw] max-w-sm pointer-events-none">
          <div className="bg-white rounded-2xl shadow-2xl border border-blue-100 p-5 animate-paper-airplane pointer-events-auto">
